...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Konfigurieren des Spiels "You Don\'t know Jack".', add_help=False)
    parser.add_argument('--help', action='store_true', help='anzeigen diese Hilfe')
